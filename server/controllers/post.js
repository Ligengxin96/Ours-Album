...
export const getPosts = async (req, res) => { 
    try {
        ...
        console.log(new Date(), `Get posts successful. Find posts count: ${post.length}, totalCount: ${total}, currentPage: ${currentPage}, maxPage: ${ Math.ceil(total / limit) }`);
...
export const updatePost = async (req, res) => {
    try {
        ...
        console.log(new Date(), `Updating post, userId: ${userId}, postId: ${id}, currentPage: ${currentPage}`);
...
export const likePost = async (req, res) => {
    try {
        ...
        const { id } = req.params;
        const { currentPage } = req.body
        console.log(new Date(), `Likeing post, userId: ${userId}, postId: ${id}, currentPage: ${currentPage}`);
...
export const deletePost = async (req, res) => {
    try {
        ...
        console.log(new Date(), `Deleting post, userId: ${userId}, postId: ${id}, currentPage: ${currentPage}`);
...
export const commentPost = async (req, res) => {
    try {
        ...
        console.log(new Date(), `Commenting post, userId: ${userId}, postId: ${id}, comment: ${comment}`);
